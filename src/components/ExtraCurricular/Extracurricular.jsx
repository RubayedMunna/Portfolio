                                ...
                                <div className="px-6 py-4">
                                    ...
                                    <div className="flex items-center mt-2 text-gray-600">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6 mr-2">
                                            <path fillRule="evenodd" d="M6 2.25a.75.75 0 0 1 .75-.75h10.5a.75.75 0 0 1 .75.75v.75h.75A2.25 2.25 0 0 1 21 5.25v15A2.25 2.25 0 0 1 18.75 22.5H5.25A2.25 2.25 0 0 1 3 20.25v-15A2.25 2.25 0 0 1 5.25 3h.75v-.75ZM5.25 4.5A.75.75 0 0 0 4.5 5.25v15c0 .414.336.75.75.75h13.5a.75.75 0 0 0 .75-.75v-15a.75.75 0 0 0-.75-.75H17.5v.75a.75.75 0 0 1-1.5 0V3H8v.75a.75.75 0 0 1-1.5 0V3H5.25Zm1.5 4.5a.75.75 0 0 1 1.5 0v8.25a.75.75 0 0 1-1.5 0V9Zm9.75 0a.75.75 0 0 0-1.5 0v8.25a.75.75 0 0 0 1.5 0V9Zm-6.75 0a.75.75 0 0 0-1.5 0v8.25a.75.75 0 0 0 1.5 0V9Z" clipRule="evenodd" />
                                        </svg>
                                    ...
                                    <div className="flex items-center mt-2">
                                        <span className="bg-gray-200 text-gray-700 font-semibold py-1 px-2 rounded-lg mr-4">{competition.status}</span>
                                    </div>

                ...
                <header className="relative mb-10 overflow-hidden rounded-2xl bg-gradient-to-r from-amber-600 via-amber-700 to-amber-800 text-white shadow-2xl">
                    ...
                    <div className="relative container mx-auto px-6 py-6 flex items-center justify-between">
                        ...
                        <div className="flex items-center space-x-4">
                            ...
                            <div>
                                <h1 className="text-4xl font-extrabold tracking-tight">Professional Experiences</h1>
                    ...
                    <div className="container mx-auto mt-5">
                        <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-1 xl:grid-cols-1 gap-4">
                            <div>
                                <div className='experience mb-16 relative'>
                                    {/* Enhanced Rope line with texture */}
                                    ...
                                    {cards.map((card, index) => (
                                        <div key={card.id} className="relative z-10">
                                            {/* Education card */}
                                            <div className={`w-4/5 mx-auto bg-white shadow-xl overflow-hidden pb-3 rounded-xl border-2 border-amber-700 my-12 relative transition-all duration-300 hover:scale-105 ${
                                                ...
                                                <div className="bg-gradient-to-r from-white to-amber-50 text-gray-750 px-2 py-1">
                                                    <h2 className="text-2xl font-bold flex items-center px-10">
                                                        <span className='bg-white text-gray-900 px-4 py-2 rounded-lg shadow-sm'>
                                                            {card.jobTitle}
                                                        </span>
                                                    </h2>
                                                    
                                                    <h2 className="text-xl flex items-center px-10 mt-2">
                                                        <span className='bg-white text-gray-700 px-4 py-2 rounded-lg shadow-sm'>
                                                            {card.jobType}
                                                        </span>
                                                    </h2>
                                                    
                                                    <h2 className="text-xl font-bold flex items-center px-10 mt-2">
                                                        ...
                                                        <span className='bg-white text-gray-700 pr-4 pl-2 rounded-lg shadow-sm ml-2'>
                                                            {card.jobInstitution}, {card.institutionAddress}
                                                        </span>
                                                    </h2>

                                                    <div className="bg-white text-white px-6 py-3">
                                                        <h2 className="text-l text-gray-700">
                                                            <span className={"bg-amber-600 mx-4 text-white px-4 py-2 rounded-lg shadow-md font-semibold"}>
                                                                {card.from} - {card.to} : {card.duration}
                                                            </span>
                                                        </h2>
                                                    </div>

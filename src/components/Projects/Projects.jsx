...
//                     <header className="bg-amber-600 text-white py-4 rounded-lg mb-8 shadow-lg">
...
//                                 <div 
//                                     key={index} 
//                                     className="max-w-full rounded-xl overflow-hidden shadow-xl bg-white border-2 border-amber-200 transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:border-amber-500 hover:bg-amber-50"
//                                 >
//                                     <div className="bg-gradient-to-r from-amber-600 to-amber-700 h-3 w-full"></div>
//                                     <div className="px-6 py-4">
//                                         <div className="font-bold text-xl mb-3 text-gray-800">{project.projectName}</div>
//                                         <ul className="list-disc mt-4 ml-4 text-gray-700 text-base space-y-2">
//                                             {project.projectDescription.map((description, i) => (
//                                                 <li key={i} className="leading-relaxed">{description}</li>
//                                             ))}
//                                         </ul>
...
//                                                 </svg>
//                                                 <span className="text-gray-700 font-medium">{project.institutionName}</span>
//                                             </li>
//                                         </ul>
//                                     </div>
...
//                                                 className="flex items-center bg-gray-800 hover:bg-black text-white font-bold py-2 px-3 rounded-lg mr-2 transition-all duration-300 hover:scale-110 shadow-md" 
//                                                 target="_blank" 
        ...
        <div className="hidden md:block bg-white/10 px-4 py-2 rounded-full border border-white/20 text-sm font-medium tracking-wide hover:bg-white/20 transition">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {projects.map((project, index) => (
                    <div
                        key={index}
                        className="relative rounded-xl overflow-hidden shadow-xl bg-white border-2 border-amber-200 transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:border-amber-500 hover:bg-amber-50"
                    >
                        <div className="bg-gradient-to-r from-amber-600 to-amber-700 h-3 w-full"></div>
                        <div className="px-6 py-4">

                        ...
                        <div className="flex items-center space-x-4">
                            <div className="w-12 h-12 rounded-full bg-white/20 backdrop-blur-md flex items-center justify-center shadow-md border border-white/30">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="white" className="w-6 h-6">
                                    {/* Skills / competency icon (star) */}
                                    <path strokeLinecap="round" strokeLinejoin="round" d="M12 6l2.09 6.26L20 12l-4.91 3.74L15.18 20 12 16.91 8.82 20l1.09-4.26L5 12l5.91-.74L12 6z" />
                                </svg>
                            </div>
                            <div>
                                <h1 className="text-4xl font-extrabold tracking-tight">Skills</h1>
